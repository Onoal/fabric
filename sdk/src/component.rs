...
pub mod advanced {
    ...
    pub use fabric_component::{
        ...
        OperationRegistrar, OperationRegistrarService,
    };
}
...
pub use fabric_component::{
    ...
    ComponentScope, ComponentStatus, DegradedComponentHealth, InvocationContext, InvocationId,
    InvocationOrigin, InvocationRail, InvocationService, OperationDefinition, OperationDescriptor,
    OperationFuture, OperationId, OperationKey, OperationRail, OperationRailService,
    OperationRegistrar, OperationRegistrarService, OperationTypeId, ParticipationState,
    ProvidedComponentContract, ResolvedComponentRequirement, Surface, SurfaceId, SurfaceRegistry,
    SurfaceRegistryService, component_communication_contract_id,
    component_communication_contract_key, component_control_contract_id,
    component_control_contract_key, component_host_contract_id, component_host_contract_key,
    ...
    component_requirement_contract_id, component_requirement_contract_key, invocation_contract_id,
