...
pub use authoring::{
    ...
    FabricBuildError, FabricContribution, Instance, InstanceFacility, InstanceFacilityContext,
    InstanceFacilityError, InstanceFacilityName, InstanceFacilityObservation, InstanceObservation,
