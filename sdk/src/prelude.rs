...
pub use crate::{
    ...
    ComponentAugmentationRequirement, ComponentAugmentationRuntimePreparation,
    ComponentAugmentationSet, ComponentAugmentationSetAdapterRealization,
    ComponentAugmentationSetAttachment, ComponentAugmentationSetRealization,
    ComponentAugmentationSupportDefinition, ComponentDefinition, ComponentError, ComponentId,
    ComponentRealization, ComponentRealizationContract, ComponentRequirementKind,
    ComponentResourceBindingManifestEntry, ComponentResourceRequirement,
    ComponentResourceRequirementName, ComponentResourceScope, ComponentRuntimeContribution,
    ComponentRuntimePreparation, ComponentRuntimeTeardownError, ComponentRuntimeTeardownFailure,
