...
pub use adapted::{
    ...
    AdaptedOperationsRealization, AdaptedOperationsRealizationContract,
    AdaptedOperationsRealizationService, AdaptedOperationsService, AlternateOperationsAdapter,
    AlternateOperationsAdapterConfig, BoundAdaptedOperationsRealization, FixedOperationsAdapter,
    FixedOperationsAdapterConfig, HostBoundOperationsAdapter, HostBoundOperationsAdapterConfig,
    IncompatibleSchemaOperationsAdapter, IncompatibleSchemaOperationsAdapterConfig,
    MissingContractOperationsAdapter, WrongVersionOperationsAdapter,
    WrongVersionOperationsAdapterConfig, adapted_operations_contract_id,
    adapted_operations_contract_key, adapted_operations_contract_version,
    adapted_operations_realization_contract_id, adapted_operations_realization_contract_key,
    adapted_operations_realization_contract_version, adapted_operations_realization_requirement,
