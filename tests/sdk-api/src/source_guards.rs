...
fn canonical_distribution_packages_keep_the_fabric_rust_crate_names() {
    ...
    for dependency in [
        "fabric-host = { package = \"onoal-fabric-host\", version = \"0.4.7\", path = \"host\" }",
        "fabric-core = { package = \"onoal-fabric-core\", version = \"0.4.7\", path = \"core\" }",
        "fabric-resource = { package = \"onoal-fabric-resource\", version = \"0.4.7\", path = \"resource\" }",
        "fabric-system = { package = \"onoal-fabric-system\", version = \"0.4.7\", path = \"system\" }",
        "fabric-component = { package = \"onoal-fabric-component\", version = \"0.4.7\", path = \"component\" }",
        "fabric-sdk-macros = { package = \"onoal-fabric-sdk-macros\", version = \"0.4.7\", path = \"sdk-macros\" }",
        "fabric = { package = \"onoal-fabric\", version = \"0.4.7\", path = \"sdk\" }",
    ] {
        assert!(
    ...
    assert!(
        workspace_manifest.contains("version = \"0.4.7\""),
        "the Fabric family source graph must share the 0.4.7 workspace version"
    );
    for manifest in [
        "host/Cargo.toml",
        "core/Cargo.toml",
